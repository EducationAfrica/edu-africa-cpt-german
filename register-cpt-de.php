...
function github_plugin_updater_test_init() {
  ...
  if ( is_admin() ) { // note the use of is_admin() to double check that this is happening in the admin
    ...
    $config = array(
      ...
      'api_url' => 'https://api.github.com/repos/EducationAfrica/edu-africa-cpt-german',
      'raw_url' => 'https://raw.github.com/EducationAfrica/edu-africa-cpt-german/master',
      'github_url' => 'https://github.com/EducationAfrica/edu-africa-cpt-german',
      'zip_url' => 'https://github.com/EducationAfrica/edu-africa-cpt-german/archive/master.zip',
      'sslverify' => true,
      'requires' => '4.0',
      'tested' => '4.0',
      'readme' => 'README.md',
